...
int main(){  
   ...
   cout<<"-----------------------------------------------------------\n"<<endl;
    ...
    PrioQueue<int>* colaVuelos = new PrioQueue<int>();
    colaVuelos->enqueue(1,3);
    colaVuelos->enqueue(2,1);
    colaVuelos->enqueue(3,2);
    colaVuelos->enqueue(4,4);
    colaVuelos->enqueue(5,1);
    colaVuelos->enqueue(6,3);
    colaVuelos->enqueue(7,4);
    colaVuelos->enqueue(8,3);
